...
claude-mux --show                    # aktuelles Projekt wieder einblenden
...
claude-mux --delete ~/projekte/alt   # Projektordner in den Systempapierkörb verschieben (macOS)
```
...
# Projektmarkierungen
claude-mux --hide                    # aktuelles Projekt aus -L-Auflistungen ausblenden
claude-mux --hide ~/projekte/alt     # ein bestimmtes Projekt ausblenden
claude-mux --show                    # aktuelles Projekt wieder einblenden
claude-mux --protect                 # diese Sitzung vor versehentlichem Herunterfahren schützen
claude-mux --unprotect               # Schutz entfernen
claude-mux --delete ~/projekte/alt           # Projektordner in den Systempapierkörb verschieben (macOS)
claude-mux --delete ~/projekte/alt --yes     # gleich, ohne Bestätigungsdialog
