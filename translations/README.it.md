...
La configurazione (`~/.claude-mux/config`) viene creata automaticamente al primo avvio. Per la configurazione del LaunchAgent (sessione home all'accesso), clona il repository ed esegui `install.sh`.
