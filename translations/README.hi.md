...
होम सेशन हमेशा **सुरक्षित** होता है - `--shutdown home` इसे `--force` के बिना रोकने से इनकार करता है। सुरक्षित सेशन status column में `protected` दिखाते हैं; calling session को name column में `>` से चिह्नित किया जाता है।
...
| `protected` | `running` जैसा ही, लेकिन सेशन सुरक्षित है — `--shutdown` को रोकने के लिए `--force` की आवश्यकता है। होम सेशन हमेशा सुरक्षित होता है। |
